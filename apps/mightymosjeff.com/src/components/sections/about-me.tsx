...
export function AboutMe(): React.ReactElement {
    ...
    return (
        <Center>
            <Stack justify="center" maxW="40rem" py={6} spacing={8} w="full">
                <UserCard
                    bgImage="/assets/images/dope-tron.png"
                    user={user}
                    variant="outline"
                />
                <Stack spacing={5}>
                    ...
                    <Text color="gray.400" fontFamily="body" fontWeight={500}>
                        Since before I can remember, I had always wanted to go
                        to Notre Dame. I was lucky enough to be accepted as an
                        early admission and matriculated there in the fall of
                        1998. Those were somewhat lean years for the football
                        team, but we persevered through the cold winters and{' '}
                        <Link
                            isExternal
                        ...
                        anyway. I studied Computer Engineering, although I
                        preferred the Computer Science part over the Electrical
                        Engineering (and still do). I graduated with honors and
                        spent the following summer back in Buffalo hunting in
                        the difficult post-9/11 job market.
                    </Text>
                    <Text color="gray.400" fontFamily="body" fontWeight={500}>
                        I have an amazing wife and two girls that I try to make
                        laugh at every opportunity. We also have a Chocolate Lab
                        puppy who loves taking things and being chased. Other
                        than chasing my dog, my hobbies include:
                    </Text>
